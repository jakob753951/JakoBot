...
class Configuration:
	def __init__(self, token = '', prefix = '.', description = '', name = '', chan_forward_dm = '', minutes_between_saves = '', minutes_between_checks = '', servers = {}):
		self.token = token
		self.prefix = prefix
		...
		for key, value in servers.items():
			fields = ['role_lurker', 'days_inactivity_before_role', 'chan_truth_or_dare']
